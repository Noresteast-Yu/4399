...
const dataMeta = require("../data/dataMeta")
...
function getDataMeta() {
  return {
    ...dataMeta,
    maintainers: (dataMeta.maintainers || []).slice(),
    searchable_examples: (dataMeta.searchable_examples || []).slice(),
    notes: (dataMeta.notes || []).slice()
  }
}
